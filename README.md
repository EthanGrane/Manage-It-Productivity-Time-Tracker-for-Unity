...
Git
```bash
git clone https://github.com/EthanGrane/Manage-It-Productivity-Time-Tracker-for-Unity.git
```

Git URL (Unity Package Manager)
```bash
https://github.com/EthanGrane/Manage-It-Productivity-Time-Tracker-for-Unity.git
```
